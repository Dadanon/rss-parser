...
from general import _get_channel_content, channels, patterns, Item, _get_text_without_tags
...
class RSSParser:
    ...
    def _prettify_item(self) -> Optional[Item]:
        ...
        if current_item:
            ...
            pretty_description = pretty_description_match.group(1) if pretty_description_match else current_item.description
